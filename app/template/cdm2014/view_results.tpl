...
<!-- BEGIN pools -->  
  <div class="maincontent">
    ...
    <div class="tag_cloud">
      ...
      <table width="100%">
        <!-- BEGIN next_matches -->
        <tr><td colspan="4" style="text-align:center;"><i>-> Prochain match <u>{pools.next_matches.DATE}</u> (<i>dans {pools.next_matches.DELAY}</i>) :</i>
        <!-- BEGIN list -->
        <br /><b>{pools.next_matches.list.TEAM_NAME_A} - {pools.next_matches.list.TEAM_NAME_B}</b></td></tr>
        <!-- END list -->
        <!-- END next_matches -->
        <!-- BEGIN matches -->
        ...
        <tr>
          ...
          <td width="15%" style="text-align:center;font-weight:600;font-size:15px;">{pools.matches.SCORE_A}</td>
          <td width="15%" style="text-align:center;font-weight:600;font-size:15px;">{pools.matches.SCORE_B}</td>
