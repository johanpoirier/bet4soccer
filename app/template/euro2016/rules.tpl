<div id="mainarea">
    ...
    <div class="maincontent">
        ...
        <li><u>Résultat Juste</u> : Bon pronostic de 'Victoire équipe A', 'Victoire équipe B', ou 'Match nul' <i>(à l'issue des éventuelles prolongations)</i>.</li>
        <li><u>Qualifié Trouvé (en phase finale)</u> : Bon pronostic de 'Victoire équipe A' ou 'Victoire équipe B' <i>(à l'issue des éventuels tirs aux buts)</i>.</li>
        ...
        <p>
        <ul>
        <li>Soit <b>{POINTS_POOL_TOTAL} points</b> possibles en phase de poules et <b>{POINTS_FINALS_TOTAL} points</b> en phase finale.</li>
        </ul>
        </p>
    </div>
</div>
