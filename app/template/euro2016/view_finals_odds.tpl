...
<b>{finals.rounds.ranks.teams.SCORE}</b><br /><span style="text-align:center;color:blue;font-weight:300;font-size:9px;">{finals.rounds.ranks.teams.AVG}</span><br /><span style="text-align:center;color:green;font-weight:300;font-size:9px;">{finals.rounds.ranks.teams.ODD}</span></td>
<!-- BEGIN points -->
...
<!-- END teams -->
<tr>
<td colspan="2" height="{finals.rounds.ranks.HEIGHT_BOTTOM}" style="valign=top;text-align:center;">

<a href="javascript:toggle_exact_bets({finals.rounds.ranks.MATCH_ID});"><span style="color:red;">{finals.rounds.ranks.EXACT_BETS}</span></a>
...
<br />
<a href="javascript:toggle_good_bets({finals.rounds.ranks.MATCH_ID});"><span style="color:red;">{finals.rounds.ranks.GOOD_BETS}</span></a>
