    ...
    <header>
        <table cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td>
                    <div id="logo">
                        <a href="index.php"><img src="{TPL_WEB_PATH}images/euro2016.svg" alt="UEFA Euro 2016" border="0"
                                                 width="50"/></a>
                    </div>
                </td>
                <td valign="middle">
                    <table>
                        <tr>
                            <td style="font-size:80%" align="right" valign="top">
                                ...
                                <!-- BEGIN list -->
                                <b><a href="#"
                                      onclick="window.open('/?act=view_match_stats&matchID={matches.list.ID}','statistiques','menubar=no, status=no, scrollbars=no, menubar=no, location=no, width=555, height=555')">{matches.list.TEAM_NAME_A}
                                        - {matches.list.TEAM_NAME_B}</a></b><br/>
                                <!-- END list -->
                                <!-- END matches -->
                            </td>
                        <tr>
                            <td>
                                <div>
                                    ...
                                    <!-- BEGIN account -->
                                    <a href="/?act=account">
                                        <img src="{TPL_WEB_PATH}images/account.gif" width="20px" border="0"
                                             alt="Mon compte"/>
                                        <b>{USERNAME}</b>
                                    </a>
                                    <!-- END account -->
